...
public class SidebarView extends VBox {
    ...
    public SidebarView() {
        ...
        Label chatLabel = createSidebarLabel("문의 관리", "icon-qna.png");
        ...
        chatLabel.setOnMouseClicked(e -> SceneManager.switchTo("chatList"));

        // 로그아웃 버튼
        Button logoutBtn = new Button("로그아웃");
        logoutBtn.getStyleClass().add("logout-button");

        VBox topSection = new VBox(10, logoBox, menuTitle, mainLabel, applyLabel, reviewLabel, statsLabel, chatLabel);
